// 型は細かく分けたほうが後で使いやすい。
// APIでデータセットを取得する想定ではないのであれば、もう少し厳密な型定義は可能。
export type QuestionId = string;

/**
 * 訪問者からの質問と、それに対する答回答のID。
 */
export type Answer = {
  content: string;
  nextId: QuestionId;
...
// 例えば、今回のケースでは、単にstringをstringとするのではなく、QuestionIdというエイリアスをつけると良い。
// こうすることで、nextIdとdatasetのキーが同じものであるという事がわかりやすくなる。
/**
 * 質問IDをキーとした回答。
 */
